> This is the README of the upstream project, [volumio/Volumio2-UI](https://github.com/volumio/Volumio2-UI),
> kept for reference. For Artwork One, start with the [README](../README.md) in the repository root.
